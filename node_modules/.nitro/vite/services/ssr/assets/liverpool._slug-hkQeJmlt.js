import { i as SITE, r as SERVICES } from "./site-BPt2AzFt.js";
import { t as Route } from "./liverpool._slug-DfS0Jycn.js";
import { t as SectionHeader } from "./SectionHeader-Bbi4m1_3.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, CheckCircle2, MessageCircle, Phone } from "lucide-react";
//#region src/routes/liverpool.$slug.tsx?tsr-split=component
var IMG = {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(SectionHeader, {
					...
					children: p.benefits.map((b) => /* @__PURE__ */ jsxs("li", {
						...
						children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-orange shrink-0 mt-0.5" }), /* @__PURE__ */ jsx("span", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Request Quote ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsxs("a", {
								href: SITE.phoneHref,
				...
				children: [/* @__PURE__ */ jsx(SectionHeader, {
					...
					children: SERVICES.slice(0, 6).map((s) => /* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: s.title
						}), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 text-orange group-hover:translate-x-1 transition-transform" })]
					}, s.slug))
				})]
			})
		})
