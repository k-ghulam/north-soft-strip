import { i as SITE, n as PROPERTY_TYPES, r as SERVICES, t as AREAS } from "./site-BPt2AzFt.js";
import { t as faqs } from "./routes-7qMR4Lx2.js";
import { t as SectionHeader } from "./SectionHeader-Bbi4m1_3.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, CheckCircle2, Clock, HardHat, Home, MessageCircle, Phone, PoundSterling, Shield, Sparkles, Star, Store, Users } from "lucide-react";
...
function HeroSlider() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			SLIDES.map((s, idx) => /* @__PURE__ */ jsx("img", {
				src: s.img,
				alt: s.title,
				width: 1920,
				height: 1200,
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-[#0f2b46]/55 to-[#0f2b46]/90" }),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("span", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-orange animate-pulse" }),
								SLIDES[i].eyebrow,
								" · Liverpool"
							]
						}),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Get Free Quote ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								}),
								/* @__PURE__ */ jsxs("a", {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: [...trustBadges, ...trustBadges].map((b, i) => /* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2.5 text-white/80 text-sm font-semibold",
					children: [
						/* @__PURE__ */ jsx(b.icon, { className: "h-4 w-4 text-orange" }),
						" ",
						b.label
					]
				}, i))
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: SERVICES.slice(0, 6).map((s) => /* @__PURE__ */ jsxs(Link, {
						to: "/services/$slug",
						params: { slug: s.slug },
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-linear-to-t from-navy/70 via-navy/10 to-transparent" }),
								/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Home, { className: "h-3.5 w-3.5" }), " Residential"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "inline-flex items-center gap-1.5 rounded-full bg-orange text-white px-4 py-2 text-xs font-semibold",
							children: [/* @__PURE__ */ jsx(Store, { className: "h-3.5 w-3.5" }), " Light commercial"]
						})]
					}),
					/* @__PURE__ */ jsxs("p", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: AREAS.map((a) => /* @__PURE__ */ jsxs(Link, {
						to: "/areas/$slug",
						params: { slug: a.slug },
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: a.name
							}), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 text-white/80 group-hover:text-white group-hover:translate-x-1 transition-all" })]
						}), /* @__PURE__ */ jsxs("span", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(SectionHeader, {
					...
					children: [/* @__PURE__ */ jsxs("a", {
						...
						children: ["All FAQs ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					})]
				})] }), /* @__PURE__ */ jsx("div", {
					className: "space-y-3",
					children: faqs.map((f, i) => /* @__PURE__ */ jsxs("details", {
						...
						children: [/* @__PURE__ */ jsxs("summary", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 rotate-90 group-open:-rotate-90 transition-transform" })
							})]
						}), /* @__PURE__ */ jsx("p", {
